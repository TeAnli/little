...
export const icons = {
  ...
  save: (size?: number) => wrap(mdi('content-save-outline'), size),
  preview: (size?: number) => wrap(mdi('eye-outline'), size),
  edit: (size?: number) => wrap(mdi('pencil-outline'), size),
  split: (size?: number) => wrap(mdi('view-split-vertical'), size),
  heading: (size?: number) => wrap(mdi('format-header-pound'), size),
  bold: (size?: number) => wrap(mdi('format-bold'), size),
  italic: (size?: number) => wrap(mdi('format-italic'), size),
  link: (size?: number) => wrap(mdi('link-variant'), size),
  image: (size?: number) => wrap(mdi('image-outline'), size),
  quote: (size?: number) => wrap(mdi('format-quote-close'), size),
  code: (size?: number) => wrap(mdi('code-braces'), size),
  bulletList: (size?: number) => wrap(mdi('format-list-bulleted'), size),
  orderedList: (size?: number) => wrap(mdi('format-list-numbered'), size),
  table: (size?: number) => wrap(mdi('table'), size),
  horizontalRule: (size?: number) => wrap(mdi('minus'), size),
  math: (size?: number) => wrap(mdi('function-variant'), size),
};
